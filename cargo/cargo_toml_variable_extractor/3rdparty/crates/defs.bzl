...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "toml": Label("@rules_rust_ctve//:toml-0.8.20"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.cargo-util-schemas-0.3.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__displaydoc-0.2.5",
        sha256 = "97369cbbc041bc366949bc74d34658d6cda5621039731c6310521892a3a20ae0",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/displaydoc/0.2.5/download"],
        strip_prefix = "displaydoc-0.2.5",
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.displaydoc-0.2.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.equivalent-1.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.erased-serde-0.4.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.form_urlencoded-1.2.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__hashbrown-0.15.2",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.hashbrown-0.15.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_collections-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_collections-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_locid-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_locid-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_locid_transform-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_locid_transform-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_locid_transform_data-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_locid_transform_data-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_normalizer-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_normalizer-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_normalizer_data-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_normalizer_data-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_properties-1.5.1",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_properties-1.5.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_properties_data-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_properties_data-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_provider-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_provider-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__icu_provider_macros-1.5.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.icu_provider_macros-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__idna-1.0.3",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.idna-1.0.3.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__idna_adapter-1.2.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.idna_adapter-1.2.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__indexmap-2.7.1",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.indexmap-2.7.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__litemap-0.7.4",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.litemap-0.7.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.memchr-2.7.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.num-traits-0.2.19.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.ordered-float-2.10.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.pathdiff-0.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.percent-encoding-2.3.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__proc-macro2-1.0.93",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.proc-macro2-1.0.93.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__quote-1.0.38",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.quote-1.0.38.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__semver-1.0.25",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.semver-1.0.25.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__serde-1.0.217",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.serde-1.0.217.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.serde-untagged-0.1.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.serde-value-0.7.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__serde_derive-1.0.217",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.serde_derive-1.0.217.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__serde_spanned-0.6.8",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.serde_spanned-0.6.8.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__smallvec-1.13.2",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.smallvec-1.13.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__stable_deref_trait-1.2.0",
        sha256 = "a8f112729512f8e442d81f95a8a7ddf2b7c6b8a1a6f509a95864142b30cab2d3",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/stable_deref_trait/1.2.0/download"],
        strip_prefix = "stable_deref_trait-1.2.0",
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.stable_deref_trait-1.2.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__syn-2.0.98",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.syn-2.0.98.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__synstructure-0.13.1",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.synstructure-0.13.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__thiserror-1.0.69",
        sha256 = "b6aaf5339b578ea85b50e080feb250a3e8ae8cfcdff9a461c9ec2904bc923f52",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/thiserror/1.0.69/download"],
        strip_prefix = "thiserror-1.0.69",
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.thiserror-1.0.69.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__thiserror-impl-1.0.69",
        sha256 = "4fee6c4efc90059e10f81e6d42c60a18f76588c3d74cb83a0b242a2b6c7504c1",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/thiserror-impl/1.0.69/download"],
        strip_prefix = "thiserror-impl-1.0.69",
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.thiserror-impl-1.0.69.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__tinystr-0.7.6",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.tinystr-0.7.6.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__toml-0.8.20",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.toml-0.8.20.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__toml_datetime-0.6.8",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.toml_datetime-0.6.8.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__toml_edit-0.22.24",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.toml_edit-0.22.24.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__typeid-1.0.2",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.typeid-1.0.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__unicode-ident-1.0.16",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.unicode-ident-1.0.16.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__unicode-xid-0.2.6",
        sha256 = "ebc1c04c71510c7f702b52b7c350734c9ff1295c464a03335b00bb84fc54f853",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/unicode-xid/0.2.6/download"],
        strip_prefix = "unicode-xid-0.2.6",
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.unicode-xid-0.2.6.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__url-2.5.4",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.url-2.5.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__utf16_iter-1.0.5",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.utf16_iter-1.0.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__utf8_iter-1.0.4",
        sha256 = "b6c140620e7ffbb22c2dee59cafe6084a59b5ffc27a8859a5f0d494b5d52b6be",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/utf8_iter/1.0.4/download"],
        strip_prefix = "utf8_iter-1.0.4",
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.utf8_iter-1.0.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__winnow-0.7.2",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.winnow-0.7.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__write16-1.0.0",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.write16-1.0.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__writeable-0.5.5",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.writeable-0.5.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__yoke-0.7.5",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.yoke-0.7.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__yoke-derive-0.7.5",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.yoke-derive-0.7.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__zerofrom-0.1.5",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.zerofrom-0.1.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__zerofrom-derive-0.1.5",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.zerofrom-derive-0.1.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__zerovec-0.10.4",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.zerovec-0.10.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_ctve__zerovec-derive-0.10.3",
        ...
        build_file = Label("//cargo/cargo_toml_variable_extractor/3rdparty/crates:BUILD.zerovec-derive-0.10.3.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "rules_rust_ctve__toml-0.8.20", is_dev_dep = False),
    ]
